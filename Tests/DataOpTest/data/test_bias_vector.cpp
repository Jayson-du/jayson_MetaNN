...
void test_bias_vector_case1() {
  ...
  static_assert(IsVector<BiasVector<Scalar<CheckElement, CheckDevice>> &&>);
  static_assert(
      IsVector<const BiasVector<Scalar<CheckElement, CheckDevice>> &>);
  static_assert(
      IsVector<const BiasVector<Scalar<CheckElement, CheckDevice>> &&>);

  BiasVector rm(
      100, 37,
      Scalar<CheckElement, CheckDevice>{static_cast<CheckElement>(0.3)});
...
void test_bias_vector_case2() {
  ...
  BiasVector rm2(
      50, 16,
      Scalar<CheckElement, CheckDevice>{static_cast<CheckElement>(0.1)});
