...
void test_dynamic_scalar_case1() {
  ...
  using CheckType =
      DynamicData<CheckElement, CheckDevice, CategoryTags::Tensor<0>>;
...
void test_dynamic_matrix_case1() {
  ...
  using CheckType =
      DynamicData<CheckElement, CheckDevice, CategoryTags::Tensor<2>>;
...
void test_dynamic_3d_array_case1() {
  ...
  using CheckType =
      DynamicData<CheckElement, CheckDevice, CategoryTags::Tensor<3>>;
...
void test_dynamic_batch_scalar_case1() {
  ...
  using CheckType =
      DynamicData<CheckElement, CheckDevice, CategoryTags::Tensor<1>>;
...
void test_dynamic_batch_3d_array_case1() {
  ...
  using CheckType =
      DynamicData<CheckElement, CheckDevice, CategoryTags::Tensor<4>>;
