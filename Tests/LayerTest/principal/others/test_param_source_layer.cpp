...
void test_param_source_layer1() {
  ...
  using RootLayer =
      MakeInferLayer<ParamSourceLayer,
...
void test_param_source_layer2() {
  ...
  using RootLayer =
      MakeInferLayer<ParamSourceLayer, PInitializerIs<RootFiller>,
                     PParamTypeIs<Matrix<CheckElement, CheckDevice>>>;
  static_assert(!RootLayer::IsFeedbackOutput, "Test Error");
  static_assert(!RootLayer::IsUpdate, "Test Error");
...
void test_param_source_layer5() {
  ...
  using RootLayer =
      MakeTrainLayer<ParamSourceLayer, LayerInMap<>,
                     PParamTypeIs<Matrix<CheckElement, CheckDevice>>>;
  static_assert(!RootLayer::IsFeedbackOutput, "Test Error");
  static_assert(!RootLayer::IsUpdate, "Test Error");
...
void test_param_source_layer6() {
  ...
  using RootLayer =
      MakeTrainLayer<ParamSourceLayer, LayerInMap<>, PUpdate,
                     PParamTypeIs<Matrix<CheckElement, CheckDevice>>>;
...
void test_param_source_layer8() {
  ...
  using RootLayer =
      MakeTrainLayer<ParamSourceLayer, LayerInMap<>, PUpdate,
                     PParamTypeIs<ZeroTensor<CheckElement, CheckDevice, 2>>>;
  static_assert(!RootLayer::IsFeedbackOutput);
  static_assert(!RootLayer::IsUpdate);
  ...
  auto w = fpRes.template Get<LayerOutput>();
  static_assert(
      std::is_same_v<decltype(w), ZeroTensor<CheckElement, CheckDevice, 2>>);
