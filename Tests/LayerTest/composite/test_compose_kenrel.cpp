...
void test_compose_kernel1() {
  ...
  using check1 = SeparateClauses_<
      Sublayer<Sublayer1, AddLayer>, Sublayer<Sublayer2, MultiplyLayer>,
      Sublayer<Sublayer3, SigmoidLayer>, Sublayer<Sublayer4, TanhLayer>,
      Sublayer<Sublayer5, AddLayer>, InConnect<Input1, Sublayer1, LeftOperand>,
  ...
  static_assert(
      std::is_same_v<check1::OutConnectRes,
                     ClauseSeq<OutConnect<Sublayer5, LayerOutput, Output1>>>);

  static_assert(
      std::is_same_v<
          ClauseRefine::InternalFMap<check1::InterConnectRes>,
          ClauseSeq<
              Helper::KVBinder<Sublayer1, Helper::ValueSequence<InternalConnect<
                                              Sublayer1, LayerOutput, Sublayer2,
                                              LeftOperand>>>,
              Helper::KVBinder<Sublayer2,
                               Helper::ValueSequence<
                                   InternalConnect<Sublayer2, LayerOutput,
                                                   Sublayer3, LayerInput>,
                                   InternalConnect<Sublayer2, LayerOutput,
                                                   Sublayer4, LayerInput>>>,
              Helper::KVBinder<Sublayer3, Helper::ValueSequence<InternalConnect<
                                              Sublayer3, LayerOutput, Sublayer5,
                                              LeftOperand>>>,
              Helper::KVBinder<Sublayer4, Helper::ValueSequence<InternalConnect<
                                              Sublayer4, LayerOutput, Sublayer5,
                                              RightOperand>>>>>);

  static_assert(
      std::is_same_v<
          ClauseRefine::InternalBMap<check1::InterConnectRes>,
          ClauseSeq<
              Helper::KVBinder<Sublayer2, Helper::ValueSequence<InternalConnect<
                                              Sublayer1, LayerOutput, Sublayer2,
                                              LeftOperand>>>,
              Helper::KVBinder<Sublayer3, Helper::ValueSequence<InternalConnect<
                                              Sublayer2, LayerOutput, Sublayer3,
                                              LayerInput>>>,
              Helper::KVBinder<Sublayer4, Helper::ValueSequence<InternalConnect<
                                              Sublayer2, LayerOutput, Sublayer4,
                                              LayerInput>>>,
              Helper::KVBinder<
                  Sublayer5, Helper::ValueSequence<
                                 InternalConnect<Sublayer3, LayerOutput,
                                                 Sublayer5, LeftOperand>,
                                 InternalConnect<Sublayer4, LayerOutput,
                                                 Sublayer5, RightOperand>>>>>);
  static_assert(
      std::is_same_v<
          ClauseRefine::InputFMap<check1::InConnectRes>,
          ClauseSeq<
              Helper::KVBinder<Sublayer1,
                               Helper::ValueSequence<
                                   InConnect<Input1, Sublayer1, LeftOperand>,
                                   InConnect<Input2, Sublayer1, RightOperand>>>,
              Helper::KVBinder<
                  Sublayer2, Helper::ValueSequence<InConnect<Input1, Sublayer2,
                                                             RightOperand>>>>>);

  static_assert(
      std::is_same_v<ClauseRefine::OutputBMap<check1::OutConnectRes>,
                     ClauseSeq<Helper::KVBinder<
                         Sublayer5, Helper::ValueSequence<OutConnect<
                                        Sublayer5, LayerOutput, Output1>>>>>);

  static_assert(
      std::is_same_v<
          ClauseRefine::SublayerNameSet<check1::SublayerRes>,
          ClauseSeq<Sublayer1, Sublayer2, Sublayer3, Sublayer4, Sublayer5>>);

  static_assert(
      std::is_same_v<
          ClauseRefine::SublayerMap<check1::SublayerRes>,
          ClauseSeq<
              Helper::KVBinder<Sublayer1, Sublayer<Sublayer1, AddLayer>>,
  ...
  static_assert(
      std::is_same_v<ClauseRefine::InternalInLayerSet<check1::InterConnectRes>,
                     ClauseSeq<Sublayer2, Sublayer3, Sublayer4, Sublayer5>>);
  static_assert(
      std::is_same_v<ClauseRefine::InternalOutLayerSet<check1::InterConnectRes>,
                     ClauseSeq<Sublayer1, Sublayer2, Sublayer3, Sublayer4>>);
  static_assert(
      std::is_same_v<
          ClauseRefine::InternalLayerSet<check1::InterConnectRes>,
          ClauseSeq<Sublayer2, Sublayer3, Sublayer4, Sublayer5, Sublayer1>>);

  static_assert(std::is_same_v<
                ClauseRefine::InternalInNamePortSet<check1::InterConnectRes>,
  ...
  static_assert(
      std::is_same_v<ClauseRefine::InputNamePortSet<check1::InterConnectRes,
                                                    check1::InConnectRes>,
                     ClauseSeq<Helper::Pair<Sublayer2, LeftOperand>,
                               Helper::Pair<Sublayer3, LayerInput>,
                               Helper::Pair<Sublayer4, LayerInput>,
  ...
  static_assert(
      std::is_same_v<ClauseRefine::InputLayerSet<check1::InConnectRes>,
                     ClauseSeq<Sublayer1, Sublayer2>>);
  static_assert(
      std::is_same_v<ClauseRefine::OutputPortSet<check1::OutConnectRes>,
                     ClauseSeq<Output1>>);
  static_assert(
      std::is_same_v<ClauseRefine::OutputLayerSet<check1::OutConnectRes>,
                     ClauseSeq<Sublayer5>>);

  using check2 = SeparateClauses_<
      Sublayer<Sublayer1, AddLayer>, InConnect<Input1, Sublayer1, LeftOperand>,
      InConnect<Input2, Sublayer1, RightOperand>,
      Sublayer<Sublayer2, MultiplyLayer>,
      InternalConnect<Sublayer1, LayerOutput, Sublayer2, LeftOperand>,
      InternalConnect<Sublayer2, LayerOutput, Sublayer3, LayerInput>,
  ...
  static_assert(
      std::is_same_v<ClauseRefine::InternalFMap<check1::InterConnectRes>,
                     ClauseRefine::InternalFMap<check2::InterConnectRes>>);
  static_assert(
      std::is_same_v<ClauseRefine::InternalBMap<check1::InterConnectRes>,
...
void test_compose_kernel2() {
  ...
  constexpr bool check1 = InternalTagInSublayer<
      ClauseSeq<
          InternalConnect<Sublayer1, LayerOutput, Sublayer2, LeftOperand>,
          InternalConnect<Sublayer2, LayerOutput, Sublayer3, LayerInput>,
          InternalConnect<Sublayer2, LayerOutput, Sublayer4, LayerInput>,
  ...
  constexpr bool check2 = InternalTagInSublayer<
      ClauseSeq<
          InternalConnect<Sublayer1, LayerOutput, Sublayer2, LeftOperand>,
          InternalConnect<Sublayer2, LayerOutput, Sublayer3, LayerInput>,
          InternalConnect<Sublayer2, LayerOutput, Sublayer4, LayerInput>,
  ...
  constexpr bool check3 = InternalTagInSublayer<
      ClauseSeq<
          InternalConnect<Sublayer1, LayerOutput, Sublayer2, LeftOperand>,
          InternalConnect<Sublayer2, LayerOutput, Sublayer4, LayerInput>,
          InternalConnect<Sublayer4, LayerOutput, Sublayer5, RightOperand>>,
...
void test_compose_kernel3() {
  ...
  constexpr bool check1 = InputTagInSubLayer<
      ClauseSeq<InConnect<Input1, Sublayer1, LeftOperand>,
                InConnect<Input2, Sublayer1, RightOperand>,
                InConnect<Input1, Sublayer2, RightOperand>>,
      ClauseSeq<Sublayer1, Sublayer2, Sublayer3, Sublayer4, Sublayer5>>;
  ...
  constexpr bool check2 =
      InputTagInSubLayer<ClauseSeq<InConnect<Input1, Sublayer1, LeftOperand>,
                                   InConnect<Input2, Sublayer1, RightOperand>,
                                   InConnect<Input1, Sublayer2, RightOperand>>,
...
void test_compose_kernel4() {
  ...
  constexpr bool check1 = OutputTagInSubLayer<
      ClauseSeq<OutConnect<Sublayer5, LayerOutput, Output1>>,
      ClauseSeq<Sublayer1, Sublayer3, Sublayer4, Sublayer5>>;
  static_assert(check1);

  constexpr bool check2 = OutputTagInSubLayer<
      ClauseSeq<OutConnect<Sublayer5, LayerOutput, Output1>>,
...
void test_compose_kernel5() {
  ...
  using namespace MetaNN::NSComposeKernel;
  constexpr bool check1 = SublayerTagInOtherArrays<
      ClauseSeq<Sublayer1, Sublayer2, Sublayer3, Sublayer4, Sublayer5>,
      ClauseSeq<Sublayer1, Sublayer2, Sublayer3, Sublayer4>,
      ClauseSeq<Sublayer1, Sublayer2>, ClauseSeq<Sublayer5>>;
  static_assert(check1);

  constexpr bool check2 = SublayerTagInOtherArrays<
      ClauseSeq<Sublayer1, Sublayer2, Sublayer3, Sublayer4, Sublayer5,
                Sublayer6>,
      ClauseSeq<Sublayer1, Sublayer2, Sublayer3, Sublayer4>,
      ClauseSeq<Sublayer1, Sublayer2>, ClauseSeq<Sublayer5>>;
...
void test_compose_kernel6() {
  ...
  using check1 = TopologicalOrdering_<
      ClauseSeq<Sublayer<Sublayer2, MultiplyLayer>,
                Sublayer<Sublayer1, AddLayer>, Sublayer<Sublayer5, AddLayer>,
                Sublayer<Sublayer3, SigmoidLayer>,
                Sublayer<Sublayer4, TanhLayer>>,
      InterConnects>::type;
  static_assert(
      std::is_same_v<check1, ClauseSeq<Sublayer1, Sublayer2, Sublayer3,
                                       Sublayer4, Sublayer5>>);
  cout << "done" << endl;
}
...
void test_compose_kernel7() {
  ...
  using CheckInputs =
      LayerInMap<LayerKV<Input1, Input1Type>, LayerKV<Input2, Input2Type>>;
  using CheckPolicyContainer = PolicyContainer<
      PFeedbackOutput,
  ...
  using CheckSublayerCont =
      ClauseSeq<Sublayer1, Sublayer2, Sublayer3, Sublayer4, Sublayer5>;
  using CheckSublayerClause =
      ClauseSeq<Sublayer<Sublayer1, AddLayer>,
                Sublayer<Sublayer2, MultiplyLayer>,
                Sublayer<Sublayer3, SigmoidLayer>,
                Sublayer<Sublayer4, TanhLayer>, Sublayer<Sublayer5, AddLayer>>;
  using CheckInConnects = ClauseSeq<InConnect<Input1, Sublayer1, LeftOperand>,
                                    InConnect<Input2, Sublayer1, RightOperand>,
                                    InConnect<Input1, Sublayer2, RightOperand>>;
  using CheckInterConnects = ClauseSeq<
      InternalConnect<Sublayer1, LayerOutput, Sublayer2, LeftOperand>,
      InternalConnect<Sublayer2, LayerOutput, Sublayer3, LayerInput>,
      InternalConnect<Sublayer2, LayerOutput, Sublayer4, LayerInput>,
      InternalConnect<Sublayer3, LayerOutput, Sublayer5, LeftOperand>,
      InternalConnect<Sublayer4, LayerOutput, Sublayer5, RightOperand>>;
  using CheckOutConnects =
      ClauseSeq<OutConnect<Sublayer5, LayerOutput, Output1>>;

  using Check = SublayerInstantiation_<
      CheckInputs, CheckPolicyContainer, CheckSublayerCont, CheckSublayerClause,
      CheckInConnects, CheckInterConnects, CheckOutConnects>;
  static_assert(
      std::is_same_v<
          Check::SublayerPolicy1,
          std::tuple<
              KVBinder<Sublayer1,
  ...
  static_assert(
      std::is_same_v<
          Check::SublayerPolicy2,
          std::tuple<
              KVBinder<Sublayer1, PolicyContainer<PNoUpdate, PFeedbackOutput>>,
  ...
  using Sublayer2Output =
      decltype(declval<Sublayer2Left>() * declval<Input1Type>());
  ...
  using Layer1Final = AddLayer<LayerInMap<LayerKV<LeftOperand, Input1Type>,
                                          LayerKV<RightOperand, Input2Type>>,
                               PolicyContainer<PNoUpdate, PFeedbackOutput>>;
  using Layer2Final =
      MultiplyLayer<LayerInMap<LayerKV<RightOperand, Input1Type>,
                               LayerKV<LeftOperand, Sublayer2Left>>,
                    PolicyContainer<PUpdate, PFeedbackOutput>>;
  using Layer3Final =
      SigmoidLayer<LayerInMap<LayerKV<LayerInput, Sublayer2Output>>,
                   PolicyContainer<PFeedbackOutput>>;
  using Layer4Final =
      TanhLayer<LayerInMap<LayerKV<LayerInput, Sublayer2Output>>,
                PolicyContainer<PFeedbackOutput>>;
  using Layer5Final =
      AddLayer<LayerInMap<LayerKV<LeftOperand, Sublayer3Output>,
                          LayerKV<RightOperand, Sublayer4Output>>,
               PolicyContainer<PFeedbackOutput>>;
  static_assert(std::is_same_v<Check::type,
                               std::tuple<Layer1Final, Layer2Final, Layer3Final,
                                          Layer4Final, Layer5Final>>);
  cout << "done" << endl;
}
...
void test_compose_kernel8() {
  ...
  using Layer1Final =
      AddLayer<NullParameter, PolicyContainer<PNoUpdate, PFeedbackNoOutput>>;
  using Layer2Final =
      MultiplyLayer<NullParameter, PolicyContainer<PFeedbackNoOutput>>;
  using Layer3Final = SigmoidLayer<NullParameter, PolicyContainer<>>;
  using Layer4Final = TanhLayer<NullParameter, PolicyContainer<>>;
  using Layer5Final =
      AddLayer<NullParameter, PolicyContainer<PFeedbackNoOutput>>;
...
void test_compose_kernel9() {
  ...
  static_assert(
      std::is_same_v<check, std::tuple<Layer1Final, Layer2Final, Layer3Final,
                                       Layer4Final, Layer5Final>>);
  cout << "done" << endl;
}
...
void test_compose_kernel10() {
  ...
  using CheckPolicyContainer = PolicyContainer<
      ...
      SubPolicyContainer<Sublayer5, PFeedbackNoOutput>>;
  using Check =
      ComposeKernel<LayerPortSet<Input1, Input2>, LayerPortSet<Output1>,
                    CheckInputs, CheckPolicyContainer, CT>;
  ...
  static_assert(std::is_same_v<
                ArrayType,
                NSComposeKernel::SublayerArrayMaker<
                    NSComposeKernel::ClauseSeq<Sublayer1, Sublayer2, Sublayer3,
                                               Sublayer4, Sublayer5>,
                    std::tuple<Layer1Final, Layer2Final, Layer3Final,
                               Layer4Final, Layer5Final>>>);
  static_assert(
      std::is_same_v<
          typename ArrayType::SublayerArray,
