...
void test_single_layer_perceptron1() {
  ...
  using RootLayer =
      MakeInferLayer<SingleLayerPerceptron, PActFuncIs<SigmoidLayer>,
...
void test_single_layer_perceptron3() {
  ...
  using RootLayer =
      MakeTrainLayer<SingleLayerPerceptron, CommonInputMap, PUpdate,
                     PActFuncIs<SigmoidLayer>,
                     PParamTypeIs<Matrix<CheckElement, CheckDevice>>>;
  static_assert(RootLayer::IsUpdate);
  static_assert(!RootLayer::IsFeedbackOutput);
...
void test_single_layer_perceptron4() {
  ...
  using RootLayer =
      MakeInferLayer<SingleLayerPerceptron, PActFuncIs<TanhLayer>,
                     PParamTypeIs<Matrix<CheckElement, CheckDevice>>>;
  static_assert(!RootLayer::IsUpdate);
  static_assert(!RootLayer::IsFeedbackOutput);
