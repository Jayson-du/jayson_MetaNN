...
void test_policy_operations1() {
  ...
  using input = PolicyContainer<
      PUpdate, SubPolicyContainer<Tag1, PNoUpdate, SubPolicyContainer<Tag2>>>;
  ...
  static_assert(
      is_same_v<check2, PolicyContainer<PNoUpdate, SubPolicyContainer<Tag2>>>);
