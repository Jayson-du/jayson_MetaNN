...
struct TopoPicker_ {
  using type =
      ComposeTopology<Sublayer<LinearSublayer, LinearLayer>,
                      Sublayer<ActivateSublayer, TActFunc>,
                      InConnect<LayerInput, LinearSublayer, LayerInput>,
                      InternalConnect<LinearSublayer, LayerOutput,
                                      ActivateSublayer, LayerInput>,
  ...
  static auto ctor(const std::string &p_name, TSublayerCont &&sublayerCont,
    ...
    return std::forward<TSublayerCont>(sublayerCont)
        .template Set<LinearSublayer>(p_name,
                                      ...
                                      std::forward<TBiasShape>(biasShape))
        .template Set<ActivateSublayer>(p_name + "/act",
...
struct TopoPicker_<false, TActFunc> {
  using type = ComposeTopology<
      Sublayer<WeightParamSublayer, ParamSourceLayer>,
      Sublayer<DotSublayer, DotLayer>, Sublayer<ActivateSublayer, TActFunc>,
      InConnect<LayerInput, DotSublayer, LeftOperand>,
      InternalConnect<WeightParamSublayer, LayerOutput, DotSublayer,
                      RightOperand>,
...
template <typename TInput, typename TPolicies> struct KernelConstructor_ {
  ...
  using type =
      ComposeKernel<LayerPortSet<LayerInput>, LayerPortSet<LayerOutput>, TInput,
...
class SingleLayerPerceptron
    : public NSSingleLayerPerceptron::KernelConstructor_<TInput,
                                                         TPolicies>::type {
  using TKernelCtor =
