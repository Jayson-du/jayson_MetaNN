...
template <template <typename, typename> class T, typename... TPolicies>
struct MakeInferLayer_<T, PolicyContainer<TPolicies...>>
    : MakeInferLayer_<T, TPolicies...> {};

template <template <typename, typename> class T, typename... TPolicies>
using MakeInferLayer = typename MakeInferLayer_<T, TPolicies...>::type;

template <template <typename, typename> class T, typename TInputMap,
          typename... TPolicies>
...
template <template <typename, typename> class T, typename TInputMap,
          typename... TPolicies>
struct MakeTrainLayer_<T, TInputMap, PolicyContainer<TPolicies...>>
    : MakeTrainLayer_<T, TInputMap, TPolicies...> {};
