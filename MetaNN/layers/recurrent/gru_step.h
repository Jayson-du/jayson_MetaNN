...
using Topology = ComposeTopology<
    Sublayer<Wz, WeightLayer>, Sublayer<Uz, WeightLayer>,
    Sublayer<Add_z, AddLayer>, Sublayer<Act_z, SigmoidLayer>,
    ...
    Sublayer<Wr, WeightLayer>, Sublayer<Ur, WeightLayer>,
    Sublayer<Add_r, AddLayer>, Sublayer<Act_r, SigmoidLayer>,
    ...
    Sublayer<U, WeightLayer>, InternalConnect<Mult, LayerOutput, U, LayerInput>,
    Sublayer<W, WeightLayer>, InConnect<LayerInput, W, LayerInput>,
    Sublayer<Add, AddLayer>, InternalConnect<U, LayerOutput, Add, LeftOperand>,
...
struct CalParameterPolicy_ {
  ...
  using ElementType =
      typename PolicySelect<ParamPolicy, CurLayerPolicy>::ElementType;
  using DeviceType =
      typename PolicySelect<ParamPolicy, CurLayerPolicy>::DeviceType;

  using type =
      ChangePolicy<PParamTypeIs<Matrix<ElementType, DeviceType>>, TPolicies>;
};
...
template <typename TInputMap, typename TPolicies>
class GruStep
    : public NSGruStep::Base<TInputMap,
                             NSGruStep::CalParameterPolicy<TPolicies>> {
