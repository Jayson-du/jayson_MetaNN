...
struct OperAuxParams<OpTags::DivideFromNum, TElem, TCate>
...
template <typename TElem, typename TCate>
struct OperAuxParams<OpTags::DivideByNum, TElem, TCate>
    : public OperAuxValue<TElem> {
  using TBase = OperAuxValue<TElem>;
  using TBase::TBase;
  using TBase::operator=;
...
auto operator/(TP1&& p_m1, TP2&& p_m2) {
  if constexpr (IsValidOper<OpTags::Divide, TP1, TP2>) {
    ...
    OperAuxParams<OpTags::DivideFromNum, typename rawOp::ElementType,
                  OperCateCal<OpTags::DivideFromNum, PolicyContainer<>, rawOp>>
        params(p_m1);
    ...
    OperAuxParams<OpTags::DivideByNum, typename rawOp::ElementType,
                  OperCateCal<OpTags::DivideByNum, PolicyContainer<>, rawOp>>
        params(p_m2);
