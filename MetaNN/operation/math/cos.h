...
template <> struct OperSeq_<OpTags::Cos> {
  using type = OperCalAlgoChain<TailCalculator<OperCos::NSCaseGen::EvalItem,
                                               OperCos::NSCaseGen::EvalGroup>>;
};
...
template <> struct OperSeq_<OpTags::CosGrad> {
  using type =
      OperCalAlgoChain<TailCalculator<OperCosGrad::NSCaseGen::EvalItem,
                                      OperCosGrad::NSCaseGen::EvalGroup>>;
};
...
auto CosGrad(TGrad &&p_grad, TInput &&p_input) {
  ...
  using ResType =
      Operation<OpTags::CosGrad, OperandContainer<rawGrad, rawInput>>;
