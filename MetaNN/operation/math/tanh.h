...
template <> struct OperSeq_<OpTags::Tanh> {
  using type = OperCalAlgoChain<TailCalculator<OperTanh::NSCaseGen::EvalItem,
                                               OperTanh::NSCaseGen::EvalGroup>>;
};
...
template <> struct OperSeq_<OpTags::TanhGrad> {
  using type =
      OperCalAlgoChain<TailCalculator<OperTanhGrad::NSCaseGen::EvalItem,
                                      OperTanhGrad::NSCaseGen::EvalGroup>>;
};
