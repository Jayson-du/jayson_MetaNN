...
template <> struct OperSeq_<OpTags::Asinh> {
  using type =
      OperCalAlgoChain<TailCalculator<OperAsinh::NSCaseGen::EvalItem,
                                      OperAsinh::NSCaseGen::EvalGroup>>;
};
...
template <> struct OperSeq_<OpTags::AsinhGrad> {
  using type =
      OperCalAlgoChain<TailCalculator<OperAsinhGrad::NSCaseGen::EvalItem,
                                      OperAsinhGrad::NSCaseGen::EvalGroup>>;
};
...
auto AsinhGrad(TGrad &&p_grad, TInput &&p_input) {
  ...
  using ResType =
      Operation<OpTags::AsinhGrad, OperandContainer<rawGrad, rawInput>>;
