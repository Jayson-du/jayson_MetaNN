...
template <> struct OperSeq_<OpTags::Sin> {
  using type = OperCalAlgoChain<TailCalculator<OperSin::NSCaseGen::EvalItem,
                                               OperSin::NSCaseGen::EvalGroup>>;
};
...
template <> struct OperSeq_<OpTags::SinGrad> {
  using type =
      OperCalAlgoChain<TailCalculator<OperSinGrad::NSCaseGen::EvalItem,
                                      OperSinGrad::NSCaseGen::EvalGroup>>;
};
...
auto SinGrad(TGrad &&p_grad, TInput &&p_input) {
  ...
  using ResType =
      Operation<OpTags::SinGrad, OperandContainer<rawGrad, rawInput>>;
