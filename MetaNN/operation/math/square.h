...
template <> struct OperSeq_<OpTags::Square> {
  using type =
      OperCalAlgoChain<TailCalculator<OperSquare::NSCaseGen::EvalItem,
                                      OperSquare::NSCaseGen::EvalGroup>>;
};
...
template <> struct OperSeq_<OpTags::SquareGrad> {
  using type =
      OperCalAlgoChain<TailCalculator<OperSquareGrad::NSCaseGen::EvalItem,
                                      OperSquareGrad::NSCaseGen::EvalGroup>>;
};

template <typename TGrad, typename TInput,
          std::enable_if_t<IsValidOper<OpTags::SquareGrad, TGrad, TInput>> * =
              nullptr>
auto SquareGrad(TGrad &&p_grad, TInput &&p_input) {
  ...
  using ResType =
      Operation<OpTags::SquareGrad, OperandContainer<rawGrad, rawInput>>;
