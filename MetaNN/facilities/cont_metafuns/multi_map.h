...
// =================================================================================
namespace NSInsert {
template <typename TProcessed, typename TKey, typename TValue,
          typename... TRemain>
struct imp_ {
  using Value = Helper::ValueSequence<TValue>;
  using type = Sequential::PushBack<TProcessed, Helper::KVBinder<TKey, Value>>;
};
...
template <typename TProcessed, typename TKey, typename TValue, typename TVs,
          typename... TRemain>
struct imp_<TProcessed, TKey, TValue, Helper::KVBinder<TKey, TVs>, TRemain...> {
